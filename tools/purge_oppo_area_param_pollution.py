...
NEW_CAVEAT = (
    ...
    "该批 13836 行数据已于 2026-09-22 清退，原端点已加硬阻断。"
    "现存 OPPO 跨国数据取自 REBORN 接口，覆盖 中国／日本／马来西亚，"
    "可按「CNY 折算价」正常跨国比较。"
    "【2026-09-23 补充·参考价】OPPO 各区 REBORN 只公布**在售机型**的价目，"
    "已下架机型在当地官网查无备件价（实测接口返 code=10028「Data does not exist！」，"
    "是官方如实无数据、非抓取失败）。此类机型若在中国官网有同名价，"
    "以灰色「参考·中国」徽标展示：币种 CNY、数字取自 OPPO 中国官网、"
    "属**参考而非当地官方价**，不参与「最低国/最高国/价差」归因；中国官网亦无同名价者如实留空。"
)
